...
**The mean number of steps per day = `r as.character(signif(meansteps,7))`.  
...
**The maximum number of steps, on average, in a five-minute interval is `r as.character(signif(maxvalue,5))`.  
The maximum occurs at the `r maxindex`th interval. ** 
...
```
**The number of missing values in the data set is `r sumna`.**
...
**The mean number of steps per day = `r as.character(signif(meannosteps,7))`.  
The median number of steps per day = `r as.character(signif(mediannosteps,7))`.  
